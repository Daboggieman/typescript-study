...
Design practical, consistent, responsive user interfaces for the Cee-Tailor product.
...
1. Inspect the existing design language before introducing new patterns.
2. Prioritize clarity and task completion.
3. Keep navigation predictable.
4. Use consistent spacing, typography, controls, and feedback.
5. Design loading, empty, error, and success states.
6. Do not add animation merely for decoration.
7. Animations must not interfere with usability.
8. Design for mobile and desktop.
9. Prefer reusable components over page-specific duplication.
10. Verify important flows in a real browser.

## Required Workflow

1. Understand the user task.
2. Inspect existing UI patterns.
3. Map states and interactions.
4. Implement the smallest reusable solution.
5. Verify responsive behavior.
6. Verify keyboard and accessibility behavior.
7. Use Playwright for important interactions.
