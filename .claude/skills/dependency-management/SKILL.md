...
Safely add, update, remove, and audit project dependencies.

## Project Stack

npm, Python/pip, package lockfiles, project package managers.

## Operating Principles

1. Inspect existing dependency versions before adding packages.
2. Prefer existing dependencies when they already solve the problem.
3. Use official package documentation for version-specific behavior.
4. Update lockfiles consistently.
5. Consider transitive dependencies.
6. Review security and maintenance implications.
7. Do not replace a dependency casually.
8. Test after dependency changes.
9. Do not use abandoned or suspicious packages when established alternatives exist.
10. Record reasons for significant dependency additions.

## Required Workflow

1. Identify the actual requirement.
2. Search existing dependencies.
3. Research candidate package and version.
4. Check compatibility.
5. Install/update using the project package manager.
6. Inspect lockfile changes.
7. Run tests/build.
8. Review security and bundle/runtime impact.
